...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["author_id"],
            ["users.id"],
            name=op.f("fk_blog_post_author_id_users"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["category_id"],
            ["blog_category.id"],
            name=op.f("fk_blog_post_category_id_blog_category"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["location_id"],
            ["blog_location.id"],
            name=op.f("fk_blog_post_location_id_blog_location"),
            ondelete="SET NULL",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["author_id"],
            ["users.id"],
            name=op.f("fk_blog_comment_author_id_users"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["post_id"],
            ["blog_post.id"],
            name=op.f("fk_blog_comment_post_id_blog_post"),
            ondelete="CASCADE",
        ),
