...
from src.core.exceptions.api_exceptions import PostNotFoundException, CategoryNotFoundException, LocationNotFoundException
...
class UpdatePostUseCase:
    ...
    async def execute(self, db: AsyncSession, post_id: int, data: PostUpdate) -> PostSchema:
        ...
        if data.location_id is not None and data.location_id > 0:
        ...
        elif data.location_id is not None and data.location_id <= 0:
